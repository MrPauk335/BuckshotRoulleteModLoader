...
@export var gridOffsetArray: Array[Vector3]
...
@export var hand_cigarettepack: Node3D
@export var hand_beer: Node3D
@export var hand_medicine: Node3D
@export var hand_inverter: Node3D
@export var hand_adrenaline: Node3D
@export var hand_handcuffs: Node3D
@export var hand_handsaw: Node3D
@export var hand_magnifier: Node3D
@export var hand_burnerphone: Node3D

@export var lerpDuration: float
@export var handRot_left: Vector3
@export var handRot_right: Vector3
...
func PickupItemFromTable(itemName: String):
    ...
    if (stealing):
        ...
        for res in amountArray:
            ...
            break
    await get_tree().create_timer(lerpDuration - 0.4, false).timeout
    ...
    await get_tree().create_timer(lerpDuration + 0.01, false).timeout
    HandFailsafe()
