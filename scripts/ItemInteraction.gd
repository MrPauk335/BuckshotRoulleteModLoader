...
func PickupItemFromTable(itemParent: Node3D, passedItemName: String):
    ...
    speaker_pickup.pitch_scale = randf_range(0.93, 1.0)
    speaker_pickup.play()
...
func InteractWith(itemName: String):
    ...
    match (itemName):
        ...
        "magnifying glass":
            ...
            await get_tree().create_timer(length + 0.2, false).timeout
            EnablePermissions()
        "cigarettes":
        ...
        "handsaw":
            ...
            await get_tree().create_timer(4.28 + 0.2, false).timeout
            EnablePermissions()
        "expired medicine":
        ...
        "adrenaline":
            ...
            await get_tree().create_timer(5.3 + 0.2, false).timeout
