...
func ResetAnimations():
	...
	animator_shotgun_thirdperson.play("RESET")
	if properties.is_active:
		ui_you.get_child(0).play("hide")
	SetShotgunVisible_Local(false)
...
func SmokeParticles():
	...
	match active_shooter_socket_target_direction:
		...
		"forward":
			smoke_pos = Vector3(1.22, 4.682, - 0.7)
		"self":
			smoke_pos = Vector3(12.091, 4.061, - 0.287)
...
func SetShotgunVisible_Global(setting_visible: bool):
	intermediary.SetShotgunVisible_Global(setting_visible)
