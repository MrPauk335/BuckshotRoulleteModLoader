...
func GrabBriefcase_FirstPerson():
	...
	properties.intermediary.light_center_controller.LerpEnergy(properties.intermediary.light_center.light_energy, 0, -1.8, 0.8)
	...
	properties.intermediary.light_center_controller.LerpEnergy(properties.intermediary.light_center.light_energy, default_energy, -1.8, 0.8)
